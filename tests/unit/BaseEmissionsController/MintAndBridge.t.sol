...
contract MintAndBridgeTest is BaseTest {
    ...
    function test_mintAndBridge_revertWhen_epochAlreadyMinted() external {
        ...
        vm.expectRevert(abi.encodeWithSelector(IBaseEmissionsController.BaseEmissionsController_EpochMintingLimitExceeded.selector));
    ...
    function test_mintAndBridge_revertWhen_insufficientGasPayment() external {
        ...
        vm.expectRevert(abi.encodeWithSelector(IBaseEmissionsController.BaseEmissionsController_InsufficientGasPayment.selector));
    ...
    function test_mintAndBridge_multipleEpochsNonSequential() external {
        ...
        assertEq(
            baseEmissionsController.getTotalMinted(),
            expectedTotal,
            "Total minted should equal sum of all epochs"
        );
    }
    ...
    function test_mintAndBridge_stateConsistency() external {
        ...
        assertEq(
            baseEmissionsController.getTotalMinted(),
            expectedEmissions,
            "Total minted should match"
        );
        assertEq(
            baseEmissionsController.getEpochMintedAmount(2),
            expectedEmissions,
            "Epoch amount should match"
        );
    ...
    function test_mintAndBridge_tokenApprovalAndBalance() external {
        ...
        assertEq(
            trustSupplyAfter,
            trustSupplyBefore + expectedEmissions,
