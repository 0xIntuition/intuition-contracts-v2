...
// node_modules/@gnosis.pm/zodiac/contracts/factory/FactoryFriendly.sol

/// @title Zodiac FactoryFriendly - A contract that allows other contracts to be initializable and pass bytes as
/// arguments to define contract state
...
abstract contract ERC20VotesUpgradeable is Initializable, IVotesUpgradeable, ERC20PermitUpgradeable {
    ...
    function _checkpointsLookup(Checkpoint[] storage ckpts, uint256 blockNumber) private view returns (uint256) {
        ...
        // invariant. - If the middle checkpoint is after `blockNumber`, we look in [low, mid)
    ...
    FactoryFriendly
{
    ...
    function setUp(bytes memory initializeParams) public virtual override initializer {
        ...
        ) = abi.decode(initializeParams, (string, string, address[], uint256[]));
