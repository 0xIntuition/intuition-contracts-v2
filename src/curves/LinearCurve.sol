...
import {BaseCurve} from "src/curves/BaseCurve.sol";
...
contract LinearCurve is BaseCurve {
    ...
    /// @notice In a linear curve, the base price will always be 1.  Pool ratio adjustments are dealt with in the MultiVault itself.
