...
async function main() {
	const trustTokenABI = [
		'function reinitialize(address _admin, address _baseEmissionsController) external',
	];
	...
	const reinitializeCalldata = trustTokenInterface.encodeFunctionData('reinitialize', [
		admin,
