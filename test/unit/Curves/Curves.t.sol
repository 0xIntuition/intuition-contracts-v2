...
contract BondingCurveRegistryTest is Test {
    ...
    function test_addBondingCurve_revertsOnZeroAddress() public {
        vm.prank(admin);
        vm.expectRevert(abi.encodeWithSelector(Errors.BondingCurveRegistry_ZeroAddress.selector));
    ...
    function test_addBondingCurve_revertsOnCurveAlreadyExists() public {
        ...
        vm.prank(admin);
        vm.expectRevert(abi.encodeWithSelector(Errors.BondingCurveRegistry_CurveAlreadyExists.selector));
        registry.addBondingCurve(address(linearCurve));
    }
    ...
    function test_addBondingCurve_revertsOnNonUniqueNames() public {
        ...
        vm.prank(admin);
        vm.expectRevert(abi.encodeWithSelector(Errors.BondingCurveRegistry_CurveNameNotUnique.selector));
...
contract LinearCurveTest is Test {
    ...
    function test_constructor_revertsOnEmptyName() public {
        vm.expectRevert(abi.encodeWithSelector(Errors.BaseCurve_EmptyStringNotAllowed.selector));
        new LinearCurve("");
    }
