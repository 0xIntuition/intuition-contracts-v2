...
flowchart LR
  ...
  subgraph MultiVaultLib["MultiVaultLib"]
    ...
    MultiVaultLib_deposit["deposit"]
  end
  MultiVault_deposit --> MultiVault__effectiveMsgValue
  MultiVault_deposit -.-> MultiVaultLib_deposit
  MultiVaultLib_deposit --> MultiVaultLib__addUtilization
  MultiVaultLib_deposit --> MultiVaultLib__isApprovedToDeposit
  MultiVaultLib_deposit --> MultiVaultLib__processDeposit
  ...
  style MultiVault_deposit stroke-width:3px
```
